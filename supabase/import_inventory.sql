...
INSERT INTO products (name, category_id, price, quantity, is_available, description, image_url) VALUES
  ...
  ('Aashirvaad Ata', (SELECT id FROM categories WHERE name = 'Grains & Pulses'), 250, '5 kg', true, 'atta ata aashirvaad wheat flour', 'https://www.bigbasket.com/media/uploads/p/l/161826_8-aashirvaad-atta-whole-wheat.jpg'),
